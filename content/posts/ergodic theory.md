...
Suppose $E$ is a $T$-invariant set, so $T(E)=E$ equivalently $E = T^{-1}\circ E$ so $1_{E} = 1_{T^{-1}(E)} = 1_{E}\circ T$ which implies that $1_{E}$ is constant a.e. so either $\mu(E)=0$ or $\mu(E)=1$ hence the system is ergodic.
